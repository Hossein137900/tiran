    ...
    <div className="min-h-screen  py-16 px-4 sm:px-6 lg:px-8 " dir="rtl">
      <div className="max-w-7xl mt-36 mx-auto">
        ...
        >
          ...
          <motion.div
            className="relative h-96 w-full rounded-xl overflow-hidden mb-12"
            variants={fadeIn}
          >
            <Image
        ...
        >
          ...
          >
            ...
            >
              <FaGift className="text-5xl text-gray-600 mb-4" />
              <h4 className="text-xl font-semibold mb-2">شخصی‌سازی</h4>
            ...
            <motion.div
              ...
              whileHover={{ y: -5, transition: { duration: 0.2 } }}
            >
              <FaCrown className="text-5xl text-gray-600 mb-4" />
              <h4 className="text-xl font-semibold mb-2">کیفیت برتر</h4>
              <p className="text-gray-600">
                تمامی محصولات ما از بهترین مواد و با دقت بالا ساخته شده‌اند تا
            ...
            <motion.div
              ...
              whileHover={{ y: -5, transition: { duration: 0.2 } }}
            >
              <FaAward className="text-5xl text-gray-600 mb-4" />
              <h4 className="text-xl font-semibold mb-2">مجموعه‌ای متنوع</h4>
              <p className="text-gray-600">
                از اکسسوری‌های مد روز تا محصولات لوکس، ما گزینه‌های متنوعی را
                برای نیازهای مختلف سازمانی ارائه می‌دهیم.
              </p>
            </motion.div>
          </motion.div>
        </motion.div>
        ...
        {/* Call to Action */}
        <motion.div
          className="bg-slate-600 text-white p-8 rounded-xl text-center"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeIn}
