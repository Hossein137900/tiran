...
export const metadata: Metadata = {
  title: "Tiran Shop | Explore Our Products",
  description: "Browse our collection of high-quality products at Tiran Shop",
};
  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <div className="my-28 text-center">
        <h1 className="text-4xl font-bold mb-3">محصولات</h1>
