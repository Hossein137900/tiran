      ...
      <div className="mt-28">
        ...
        >
          ...
          >
            ...
            >
              <FaCreditCard className="text-5xl text-gray-600 mb-4" />
              <h4 className="text-xl font-semibold mb-2">هزینه‌های متنوع</h4>
              <p className="text-gray-600">
                گیفت کارت‌ها در مبالغ مختلف موجود هستند تا شما بتوانید بهترین
            ...
            >
              ...
              <h4 className="text-xl font-semibold mb-2">کاربرد آسان</h4>
              <p className="text-gray-600">
                با استفاده از کد اختصاصی بر روی کارت، خرید از سایت به سادگی
                انجام می‌شود.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              whileHover={{ y: -5, transition: { duration: 0.2 } }}
            >
              <FaClock className="text-5xl text-gray-600 mb-4" />
              <h4 className="text-xl font-semibold mb-2">بدون تاریخ انقضا</h4>
              <p className="text-gray-600">
                عزیزان شما هر زمان که بخواهند می‌توانند از گیفت کارت خود استفاده
                کنند.
              </p>
            </motion.div>
          </motion.div>
        ...
        {/* Call to Action */}
        <motion.div
          className="bg-slate-600 text-white p-8 rounded-xl text-center max-w-7xl mx-auto"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeIn}
